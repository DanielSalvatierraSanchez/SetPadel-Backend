...
const { createPadelMatch, joinUserToPadelMatch, getPadelMatchByDay, getPadelMatchByAuthor, getPadelMatches, updatePadelMatch, deletePadelMatch } = require("../controllers/padelMatches");
